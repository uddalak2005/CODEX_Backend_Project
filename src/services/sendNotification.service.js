...
const sendRegistrationConfirmation = async (receiver, forEvent) => {
  ...
  <div style="font-family: 'Segoe UI', Arial, sans-serif; max-width: 600px; margin: auto; background-color: #ffffff; border-radius: 12px; overflow: hidden; border: 1px solid #e0e0e0;">
    ...
    <div style="background: linear-gradient(90deg, #4f46e5, #6366f1); padding: 20px; text-align: center; color: #fff;">
      <h1 style="margin: 0; font-size: 24px;">📩 Registration Request Received</h1>
    </div>
    ...
    <div style="padding: 25px;">
      ...
      <p style="font-size: 16px; color: #333;">
        Thank you for submitting your registration request for:
      </p>
      ...
      <p style="font-size: 15px; color: #555; margin-top: 25px; line-height: 1.5;">
        Your registration request is currently pending approval by our event administrators.
      </p>
      <p style="font-size: 15px; color: #555; line-height: 1.5;">
        Once approved, you will receive a confirmation email with RSVP details.
      </p>
    </div>
